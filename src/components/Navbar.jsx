...
function Navbar() {
    ...
    return (
        <div className='bg-white shadow w-full h-18 flex items-center justify-between px-4 md:px-12'>
            <div><h1 className='text-2xl font-bold'>Payroll Management</h1></div>
            ...
            <button className='border rounded-md px-4 py-2 font-bold bg-red-500 text-white' onClick={handleSignOut}>Logout</button>
            </div>
        </div>
    );
}
